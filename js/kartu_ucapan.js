...
btnBuat.addEventListener("click", async (e) => {
  ...
  try {
    ...
    fd.append("type", "kartu"); // PENTING: ini yang bikin masuk mode kartu
    ...
    btnBuat.textContent = "Ucapan Dibuat!";
    btnBuat.style.background = "linear-gradient(135deg, #34D399, #10B981)";
    btnBuat.style.boxShadow = "0 8px 28px rgba(52,211,153,0.4)";

    setTimeout(() => {
      window.location.href =
        "/birthday-website/kartu_ucapan_kirim.php?slug=" +
