...
<head>
    ...
    <link rel="stylesheet" href="css/kotak_kado.css?v=1" />
</head>
...
<body>
    ...
    <div class="page">
        ...
        <div class="page-header">
            ...
            <h1>Buat Kotak Kado</h1>
            <p>Isi detail di bawah untuk membuat kado ucapan spesial</p>
        </div>

        <!-- Form -->
        <form class="form-card" id="greetingForm" enctype="multipart/form-data">
            <!-- Upload Foto -->
            <div class="field-group">
                ...
                <div class="upload-area" id="uploadArea">
                    <input type="file" id="fotoInput" name="photo" accept="image/*" />
            ...
            <div class="field-group">
                ...
                <input type="text" id="namaPenerima" name="recipient_name" placeholder="Siapa yang menerima kado ini?" />
            </div>
            ...
            <div class="field-group">
                ...
                <input type="text" id="namaPengirim" name="sender_name" placeholder="Namamu sebagai pengirim" />
            </div>
            ...
            <div class="field-group">
                ...
                <textarea id="ucapan" name="message" maxlength="500" placeholder="Tulis ucapan terbaikmu di sini..."></textarea>
                <div class="char-count"><span id="charCount">0</span> / 500</div>
            </div>

            <!-- Submit -->
            <button class="btn-submit" id="btnBuat" type="button"> <svg viewBox="0 0 24 24">
    ...
    <script src="js/kotak_kado.js"></script>
</body>
